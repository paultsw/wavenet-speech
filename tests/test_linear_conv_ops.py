"""
Test linearized convolutions.
"""
import torch
from torch.autograd import Variable

from modules.linear_conv_ops import LinearConv1d, LinearCausalConv1d, LinearNonCausalConv1d, compute_new_length
...
# run causal conv1d:
conv1d = LinearConv1d(in_channels, out_channels, kernel_width, dilation=dilation_rate)
...
# run causal conv1d:
conv = CausalConv1d(in_channels, out_channels, kernel_width, dilation=dilation_rate).cuda()
ncconv = CausalConv1d(in_channels, out_channels, kernel_width, dilation=dilation_rate).cuda()
out_seq = conv(in_seq)
nc_out_seq = ncconv(in_seq)
